...
const Navbar = () => {
  ...
  return (
    <nav className="bg-white border-gray-200 py-4 lg:py-6 dark:bg-gray-900">
              ...
              >
                <Link
                  ...
                  className="relative text-gray-100 px-4 py-2 rounded-md transition-all duration-300 
                       bg-purple-800 hover:bg-purple-900 hover:text-white"
                >
                  {item}
                </Link>
              </motion.div>
            ...
            <div className="relative" ref={dropdownRef}>
              ...
              {isDropdownOpen && (
                <motion.div
                  ...
                  exit={{ opacity: 0, y: -10 }}
                  className="absolute right-0 mt-2 w-48 bg-white dark:bg-gray-800 shadow-lg rounded-lg border border-gray-200 dark:border-gray-700 z-10"
                >
                  <div className="p-4 text-center border-b dark:border-gray-700">
                    ...
                    <p className="text-gray-700 dark:text-gray-200 font-medium mt-2">
                      {user.name}
                    </p>

...
const StudentList = () => {
  ...
  return (
    <div className=" flex flex-col items-center">
      ...
      <div
        className="rounded-lg shadow-md overflow-x-auto overflow-y-auto 
                h-[80vh] lg:h-[70vh] xl:h-[80vh] 2xl:h-[90vh] grid grid-cols-1 gap-4 p-4"
      >
        {loading ? (
          ...
          <div className="bg-gray-800 p-6 rounded-lg shadow-lg w-full  max-w-lg">
            ...
            <div className="flex justify-end mt-6">
              <button
                ...
                className="p-2 bg-gray-500 text-white rounded-lg mr-2 hover:bg-gray-600"
              >
                Cancel
              </button>
              <button

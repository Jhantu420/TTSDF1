...
const CreateBranch = () => {
  ...
  return (
    <section className="bg-gray-100 flex items-center justify-center p-4 ">
      <div className="w-full max-w-3xl bg-white dark:bg-gray-800 shadow-md rounded-lg p-6 space-y-6">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {[ 
              { label: "Branch ID", name: "branchId", type: "text", placeholder: "TTSDF-RYIT-WB-001" },

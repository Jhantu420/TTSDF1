  ...
  return (
    <div className="min-h-screen flex items-center justify-center">
      <div className="bg-white p-8 rounded-2xl shadow-lg w-full max-w-md">
        ...
        {/* Forgot Password */}
        <p className="text-center mt-3 text-sm text-blue-600 cursor-pointer hover:underline" onClick={() => setIsForgotPasswordOpen(true)}>
          Forgot Password?
        </p>
      ...
      {isForgotPasswordOpen && (
        <div className="fixed inset-0 flex items-center justify-center bg-gray-900 bg-opacity-50">
          <div className="bg-white p-6 rounded-lg shadow-lg w-full max-w-sm">
            ...
            <button className="w-full text-center mt-4 text-gray-500 hover:underline" onClick={() => setIsForgotPasswordOpen(false)}>
              Cancel
            </button>
          </div>
        </div>

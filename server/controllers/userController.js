...
const createUser = async (req, res) => {
  try {
    ...
    userId = `${role}/${branchName}/${newNumber}`;
...
const updateUser = async (req, res) => {
  try {
    ...
    Object.assign(user, {
      ...
      activeStatus: activeStatus !== undefined ? activeStatus : user.activeStatus, // handle active status
    });
...
const applyCourse = async (req, res) => {
  ...
  if (!name || !mobile || !email || !center || !course) {
...
export { createUser, applyCourse, updateUser, deleteUser, getAllUsers };
